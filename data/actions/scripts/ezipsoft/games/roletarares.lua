...
local itemtable = {
	...
	[1] = {id = 29255, chance = 10}, -- Demon great axe
	[2] = {id = 29261, chance = 15}, -- Demon-axe
	[3] = {id = 29267, chance = 20}, -- Demon legs 
	[4] = {id = 29273, chance = 25},-- black knight doll addondoll
	[5] = {id = 29270, chance = 30}, -- d armor
	[6] = {id = 29276, chance = 35}, --mpa
	[7] = {id = 29279, chance = 40}, --dwarven legs
	[8] = {id = 2499, chance = 45}, --amazon helmet
	[9] = {id = 11211, chance = 50}, --mountdoll
	[10] = {id = 13166, chance = 55},
	[11] = {id = 2466, chance = 60},
	[12] = {id = 26132, chance = 65},
	[13] = {id = 13826, chance = 70},
...
function onUse(cid, item, fromPosition, itemEx, toPosition)
	...
	if not player:removeItem(30678, 1) then -- PARA JOGAR o player precisa ter o item 5091, que representa um bilhete vendido na store ou em um npc....
		return false
	end
