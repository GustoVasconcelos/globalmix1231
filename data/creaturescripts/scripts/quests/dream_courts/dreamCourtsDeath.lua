local questlog = {
	[1] = {bossName = "Faceless Bane", storageTimer = Storage.DreamCourts.BurriedCatedral.facelessTime, middlePosition = Position(33617, 32563, 13), maxValue = 4},
	...
	[9] = {bossName = "The Nightmare Beast", storageTimer = Storage.DreamCourts.DreamScar.nightmareTimer, middlePosition = Position(32207, 32045, 15), maxValue = 2},
		...
		if cName == k.bossName then
			for pid, _ in pairs(creature:getDamageMap()) do
				...
				if attackerPlayer then
					if k.storageQuestline and attackerPlayer:getStorageValue(k.storageQuestline) <= k.maxValue then
