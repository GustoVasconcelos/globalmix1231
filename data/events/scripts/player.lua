...
CONTAINER_WEIGHT = 2000000 -- 1000000 = 10k = 10000.00 oz | this function is only for containers, item below the weight determined here can be moved inside the container, for others items look game.cpp at the src

-- Items sold on the store that should not be moved off the store container
local storeItemID = {32124,32125,32126,32127,32128,32129,32109,33299,26378,29020,32109,35172,35173,35174,35175,35176,35177,35178,35179,35180}
